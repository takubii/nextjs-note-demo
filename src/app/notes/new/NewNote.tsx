    ...
    return (
        <div className="flex flex-col bg-gray-100 rounded-lg relative p-5 gap-2.5">
            <div className="sm:col-span-2">
                <label htmlFor="title" className="inline-block text-gray-800 text-sm sm:text-bash mb-2">Title</label>
                <input
                    name="title"
            ...
            <div className="flex flex-col sm:flex-row sm:justifyj-end gap-2.5">
